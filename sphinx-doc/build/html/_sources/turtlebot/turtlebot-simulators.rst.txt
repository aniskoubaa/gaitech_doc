...
.. NOTE::
    ...
    * For more details about ``Stage`` on ROS, please refer to the `Stage <http://wiki.ros.org/stage>`_ wiki page.
...
.. NOTE::
    ...
    * For more details about ``Gazebo`` on ROS, please refer to the `Gazebo <http://gazebosim.org/>`_ official page.
