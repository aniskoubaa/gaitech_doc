...
.. toctree::
   ...
   Connecting with MAVLink Ground Station <gapter-mavlink-connect-with-ground-station.rst>
   Sensor Calibration <gapter-mavlink-sensor-calibration.rst>
   Using SITL Simulator <gapter-mavlink-sitl.rst>
   Developing Apps with DroneKit <gapter-mavlink-dronekit.rst>
   Control over Internet using Dronemap Planner <gapter-mavlink-dronemap-planner.rst>
